# Bunny Girl: Obstacle Course — Build Plan

## Story / Theme
A cute cartoon little girl in pastel pink overalls with white bunny ears runs an obstacle course. Level 1 has two challenges: a bouncy beam over deadly red sticky goo, and a swing bar with a timing meter you must release at the perfect moment.
...
## Character
- Player = simple stick-together shapes: round head, two tall white ear rectangles with pink inner rects, body rect in pink overalls, small legs. About 30px wide, 50px tall. Hitbox = plain rectangle 24x48.
...
5. **Goal platform** (x 2150–2400, y 450) with a flag. Touching the flag = WIN screen.
...
6. Goal flag, WIN state, MENU state, HUD (deaths count), pastel polish (clouds, hearts).
